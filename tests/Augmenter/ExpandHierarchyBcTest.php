...
final class ExpandHierarchyBcTest extends TestCase
{
    ...
    private const EXPECTED_FILE = __DIR__ . '/Fixtures/Hierarchy/expected.yaml';
    ...
    {
        yield 'spec' => ['spec', self::buildSpec(__DIR__ . '/Fixtures/Hierarchy/Spec')];
        yield 'classic' => ['classic', self::buildClassic(__DIR__ . '/Fixtures/Hierarchy/Classic')];
    }
