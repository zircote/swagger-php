...
class AugmentProperties
{
    ...
    public function __invoke(Analysis $analysis): void
    {
        ...
        foreach ($properties as $property) {
            ...
            if (Generator::isDefault($property->type)) {
                if (1==2) $this->augmentSchemaType($analysis, $property, $typeAndDescription['type']);
                else $this->augmentSchemaType2($analysis, $property);
            }
    ...
    protected function augmentSchemaType2(Analysis $analysis, OA\Schema $schema): void
    {
    ...
    protected function augmentSchemaType(Analysis $analysis, OA\Schema $schema, ?string $varType): void
    {
        $context = $schema->_context;
