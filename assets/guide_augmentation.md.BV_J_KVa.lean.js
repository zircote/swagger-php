import{_ as h,C as p,c as k,o as d,aj as n,G as t,w as e,j as s,a as i}from"./chunks/framework.DpbEBhvk.js";const m=JSON.parse('{"title":"Augmentation","description":"","frontmatter":{},"headers":[],"relativePath":"guide/augmentation.md","filePath":"guide/augmentation.md"}'),r={name:"guide/augmentation.md"};function o(c,a,g,y,E,A){const l=p("codeblock");return d(),k("div",null,[a[4]||(a[4]=n("",7)),t(l,{id:"context-awareness"},{at:e(()=>[...a[0]||(a[0]=[s("div",{class:"language-php vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"php"),s("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#D73A49","--shiki-dark":"#F97583"}},"<?"),s("span",{style:{"--shiki-light":"#005CC5","--shiki-dark":"#79B8FF"}},"php")]),i(`
`),s("span",{class:"line"}),i(`
