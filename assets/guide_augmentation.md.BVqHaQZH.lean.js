import{_ as h,C as p,o as k,c as d,a5 as n,E as t,w as e,j as s,a as i}from"./chunks/framework.CU-GVwQ3.js";const m=JSON.parse('{"title":"Augmentation","description":"","frontmatter":{},"headers":[],"relativePath":"guide/augmentation.md","filePath":"guide/augmentation.md"}'),r={name:"guide/augmentation.md"};function o(c,a,g,y,E,A){const l=p("codeblock");return k(),d("div",null,[a[4]||(a[4]=n("",7)),t(l,{id:"context-awareness"},{at:e(()=>[...a[0]||(a[0]=[s("div",{class:"language-php vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"php"),s("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#D73A49","--shiki-dark":"#F97583"}},"<?"),s("span",{style:{"--shiki-light":"#005CC5","--shiki-dark":"#79B8FF"}},"php")]),i(`
`),s("span",{class:"line"}),i(`
